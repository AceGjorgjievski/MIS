...
import 'package:exam_schedule_google_maps/osm.dart';
...
class Location {
  ...
  Location(this.locationName, this.locationLatitude, this.locationLongitude);
}
...
class _ExamScheduleState extends State<ExamSchedule> {
  ...
  Future<void> addExamSchedule() async {
    ...
    ExamType? examType;
    Location location = Locations.FINKI;
    DateTime? date;
                  ...
                  children: [
                    ...
                    Expanded(
                      child: DropdownButtonFormField<Location>(
                        value: Locations.FINKI,
                        onChanged: (Location? value) {
                          setState(() {
                            location = value!;
                          });
                        },
                        items: Locations.getAllLocations()
    ...
    return Scaffold(
        ...
        body: Column(
          children: [
            ...
            //         Colors.cyan[300]!,
            //       )),
            //   child: const Text('Show location - Google Map'),
            // ),
            TextButton(
              onPressed: () {
                Navigator.push(
              ...
              child: const Text('Show location - OSM'),
            ),
            if (!isLoggedIn)
              TextButton(
                onPressed: () {
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  examSchedule.location.locationName,
                                  style: const TextStyle(
                                    color: Colors.grey,
                                    fontSize: 14,
                                  ),
